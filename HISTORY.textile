...
* Added a Hydra::Controllers::DownloadBehavior which allows you to easily create 
  ...
  then you can do a GET /downloads/{pid}?datastream_id=thumbnail  to get the thumnail datastream
  ...
  This example allows anyone to download a 'thumnail' datastream:

  def can_download?
    datastream.dsid == 'thumnail'
  end 
