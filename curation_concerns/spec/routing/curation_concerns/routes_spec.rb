...
module CurationConcerns
  describe 'routing' do
    ...
    describe 'generic work' do
      ...
      it 'routes to #new' do
        expect(new_sufia_generic_work_path).to eq '/concern/generic_works/new'
        expect(get('/concern/generic_works/new')).to route_to('curation_concerns/generic_works#new')
      end
      it 'routes to #show' do
        expect(sufia_generic_work_path(generic_work)).to eq "/concern/generic_works/#{generic_work.id}"
      ...
      it 'routes to #edit' do
        expect(edit_sufia_generic_work_path(generic_work)).to eq "/concern/generic_works/#{generic_work.id}/edit"
