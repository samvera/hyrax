module RightsService
  ...
  def self.select_all_options
    Deprecation.warn(RightsService, "RightsService is deprecated. Use Sufia.config.license_service_class instead. This will be removed in curation_concerns 2.0")
