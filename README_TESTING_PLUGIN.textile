...
In order to run the tests, you need to have a test rails app installed in the  hydra-plugin_test_host.  The plugin provides rake tasks for setting this up.  See "README_INSTALL_TEST_HOST":README_INSTALL_TEST_HOST.textile for instructions on setting this up.
