...
<pre>
echo "rvm use ree-1.8.7@hydra-head --create" >.rvmrc
. .rvmrc
</pre>

You should get a message like this:
 Using /usr/local/you/.rvm/gems/ree-1.8.7-2010.02 with gemset hydra-head


4. Use bundler to install the gem dependencies.
...
5. Pull a copy of jetty pre-configured for Hydra with Fedora and Solr installed.
...
8.  Load test fixtures into Fedora/Solr.
