module Hydra
  class ModsAudio < ActiveFedora::NokogiriDatastream
    ...
    # Generates an empty Mods Audio (used when you call ModsAudio.new without passing in existing xml)
      ...
      builder = Nokogiri::XML::Builder.new do |xml|
        xml.mods(:version=>"3.3", "xmlns:xlink"=>"http://www.w3.org/1999/xlink",
           ...
           "xsi:schemaLocation"=>"http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-3.xsd") {
			 ...
			 xml.originInfo {
				xml.dateIssued(:encoding=>"w3cdtf")
			 }
    ...
    def to_solr(solr_doc=Solr::Document.new)
      ...
      solr_doc << {:object_type_facet => "Audio"}
      solr_doc
    end
  end
end
