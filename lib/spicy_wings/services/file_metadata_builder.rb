...
# TODO: The file_metadata resource and the file_metadata_builder should be in Hyrax as they will be needed for non-spicy_wings valkyrie implementations too.
...
module SpicyWings
  ...
  class FileMetadataBuilder
    ...
    # @param file_set [Valkyrie::Resouce, Hydra::Works::FileSet] the associated FileSet # TODO: SPICY_WINGS - Remove Hydra::Works::FileSet as a potential type when valkyrization is complete.
    ...
    private
      ...
      def attach_file_metadata_to_valkyrie_file_set(file_metadata, file_set)
        # This is for storage adapters other than spicy_wings.  The spicy_wings storage adapter already attached the file to the file_set.
        # This process is a no-op for spicy_wings.
        # TODO: SPICY_WINGS - May need to verify this is a no-op for spicy_wings once file_set is passed in as a resource.
        # TODO: SPICY_WINGS - Need to test this against other adapters once they are available for use.
