...
require 'spicy_wings/transformer_value_mapper'
require 'spicy_wings/models/concerns/collection_behavior'
require 'spicy_wings/hydra/works/models/concerns/work_valkyrie_behavior'
require 'spicy_wings/hydra/works/models/concerns/file_set_valkyrie_behavior'
  ...
  class OrmConverter
    ...
    def self.to_valkyrie_resource_class(klass:)
      ...
      Class.new(base_for(klass: klass)) do
        include SpicyWings::CollectionBehavior if klass.included_modules.include?(Hyrax::CollectionBehavior)
        include SpicyWings::Works::WorkValkyrieBehavior if klass.included_modules.include?(Hyrax::WorkBehavior)
        include SpicyWings::Works::FileSetValkyrieBehavior if klass.included_modules.include?(Hyrax::FileSetBehavior)
