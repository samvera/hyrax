  ...
  module Pcdm
    module PcdmValkyrieBehavior
      ...
      included do
        ...
        #           Since member_ids is all that keeps these in spicy_wings, how can we do that here?
      end
      ...
      def child_collections(valkyrie: false)
        ...
        resources.map { |r| SpicyWings::ActiveFedoraConverter.new(resource: r).convert }
      end
      ...
      def child_objects(valkyrie: false)
        af_objects = SpicyWings::ActiveFedoraConverter.new(resource: self).convert.objects
      ...
      def member_of(valkyrie: false)
        ...
        return [] if af_id.nil?
        af_parents = SpicyWings::ActiveFedoraConverter.new(resource: self).convert.member_of
      ...
      def original_file
        af_object = SpicyWings::ActiveFedoraConverter.new(resource: self).convert
      ...
      def parent_works(valkyrie: false)
        af_child = SpicyWings::ActiveFedoraConverter.new(resource: self).convert
