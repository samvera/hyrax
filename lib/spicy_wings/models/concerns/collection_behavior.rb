require 'spicy_wings/services/id_converter_service'
require 'spicy_wings/hydra/works/models/concerns/collection_valkyrie_behavior'
...
module SpicyWings
  module CollectionBehavior
    ...
    included do
      include SpicyWings::Works::CollectionValkyrieBehavior
    end
    ...
    def add_collections_and_works(new_member_ids, valkyrie: false)
      ...
      af_self = SpicyWings::ActiveFedoraConverter.new(resource: self).convert
      af_ids = valkyrie ? SpicyWings::IdConverterService.convert_to_active_fedora_ids(new_member_ids) : new_member_ids
