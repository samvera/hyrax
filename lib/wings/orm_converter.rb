...
module Wings
  ##
  # Transform AF objects to Valkyrie::Resource representation.
  #
  # @example transforming an AF object a valkyrie resource
  #   work     = GenericWork.new(id: 'an_identifier')
  #   resource = Wings::OrmConverter.new(pcdm_object: pcdm_object).build
  #
