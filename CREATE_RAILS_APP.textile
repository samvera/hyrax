...
h2. VII. Update Application's application_controller and application_helper to Use Hydra-Head

h4. (1) Edit app/controllers/application_controller.rb

Change the first line to require the hydra-head controller rather than the blacklight controller:
...
Change the first line to require the hydra-head helper rather than the blacklight helper:
...
<pre>
git commit app/ -m "Update application_controller and application_helper to require hydra-head, not blacklight"
</pre>
