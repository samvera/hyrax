...
- [Configuration](#configuration)
  - [Layer 1 — turn the feature on](#layer-1--turn-the-feature-on-global)
  - [Layer 2 — choose which classes are flexible](#layer-2--choose-which-classes-are-flexible-per-class)
  - [Layer 3 — fixed YAML vs. the profile](#layer-3--decide-where-each-fields-definition-comes-from-fixed-yaml-vs-the-profile)
- [Profile structure](#profile-structure)
  - [`profile` section](#profile-section)
  - [`classes` section](#classes-section)
- [Property keys reference](#property-keys-reference)
  - [Identity & structure](#identity--structure)
  - [Cardinality (required & multiplicity)](#cardinality-required--multiplicity)
  - [Form](#form)
  - [Indexing](#indexing)
  - [View (show page & catalog)](#view-show-page--catalog)
    - [Linking a field's values](#linking-a-fields-values--exactly-what-each-link-points-at)
  - [Documentation-only keys](#documentation-only-keys-not-rendered)
  - [Example property](#example-property-all-groups-together)
- [Controlled vocabularies & authorities](#controlled-vocabularies--authorities)
  - [A. Built-in controlled fields](#a-built-in-controlled-fields-rendered-as-a-select-from-an-authority-service)
  - [B. Local-authority autocomplete](#b-field-name-autocomplete-against-a-local-authority)
  - [C. Remote-authority typeahead](#c-field-name-typeahead-against-a-remote-authority)
  - [D. Your own standalone controlled field](#d-adding-your-own-standalone-controlled-field-developer-task)
  - [E. Controlled compound sub-properties](#e-controlled-compound-sub-properties-this-one-uses-a-real-authority-key)
...
- [What is required / what makes a profile invalid](#what-is-required--what-makes-a-profile-invalid)
  - [Minimal valid profile](#minimal-valid-profile)
- [Property order — how sequence drives forms & show pages](#property-order--how-sequence-drives-forms--show-pages)
  - [Profile-driven order (form, show page)](#profile-driven-order-deposit-form-edit-form-work-show-page)
...
- [What the profile cannot control — hardcoded couplings](#what-the-profile-cannot-control--hardcoded-couplings)
  - [Sort fields](#the-big-one-sort-fields-use-different-solr-fields-than-the-profile-declares)
  - [Pre-declared CatalogController fields](#fields-pre-declared-in-the-catalogcontroller-must-match-exact-solr-field-names)
  - [Fixed display config](#fixed-display-config)
  - [Behaviors the profile can never override](#behaviors-the-profile-can-never-override)
  - [View partials the profile can't restructure](#view-partials-the-profile-cant-restructure)
...
- [Property visibility flags](#property-visibility-flags)
  - [Catalog behavior](#catalog-behavior)
  - [`view:`-driven visibility](#view-driven-visibility-show-page-and-catalog-separately)
  - [Declaring the flags](#declaring-the-flags)
...
- [Developer notes](#developer-notes)
  ...
  - [Key services & models](#key-services--models)
  - [Which version rendered a work](#which-version-rendered-a-work)
