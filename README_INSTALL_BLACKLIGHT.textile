h2. Installing Blacklight and its pre-requisites

h3. Install system pre-requisites

Ensure you have git, ruby version manager (http://rvm.beginrescueend.com/), java 1.6, and sqlite3 installed

h3. Create a gem set and install some gems to start with
...
h3. Run the Blacklight installation script
...
h3. Put your new hydra-head into version control
...
h3. Add blacklight code into your git repository (rather than as a submodule)
...
git commit -a -m "Add blacklight code into your git repository (rather than as a submodule)"
</pre>
