module CurationConcerns
  ...
  # An Actor is invoked by a controller or jobs as the result
  # of command line runner.  You may a have a stack of multiple
  # actors that each perform one specific task.  Actors should
  # have a specific task and be chained together to execute
  # more complex business purposes.
