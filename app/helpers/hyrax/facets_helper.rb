...
module Hyrax
  module FacetsHelper
    # All methods in this module are from Blacklight::FacetsHelperBehavior, blacklight v6.14.0
    # This module is used to ensure Hyrax facet views that rely on deprecated Blacklight helper methods and that do not utilize Blacklight components are still functional
