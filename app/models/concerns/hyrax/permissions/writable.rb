    ...
    module Writable
      ...
      included do
        ...
        self.paranoid_edit_permissions =
          [
            { key: :edit_groups, message: 'Public cannot have edit access', condition: ->(obj) { obj.edit_groups.include?(Hyrax.config.ability_class.public_group_name) } },
            { key: :edit_groups, message: 'Registered cannot have edit access', condition: ->(obj) { obj.edit_groups.include?(Hyrax.config.ability_class.registered_group_name) } }
          ]
      end
