...
h3. Define the ActiveFedora Model for JournalArticles
...
h5. Where to find the full tutorial on defining ActiveFedora Models
...
h4. Tests to Define Expected Behaviors
