...
h4. (0) We strongly suggest using "RVM":http://rvm.beginrescueend.com/  (Ruby Version Manager) as a means of keeping your different ruby applications with their specific gem requirements from having version clashes. 
