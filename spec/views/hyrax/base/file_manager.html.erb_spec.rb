...
RSpec.describe "hyrax/base/file_manager.html.erb" do
  context "when initialized with an ActiveFedora object" do
  ...
  context "when initialized with a Valkyrie object" do
    let(:parent) { FactoryBot.valkyrie_create(:hyrax_work, :with_member_file_sets) }
