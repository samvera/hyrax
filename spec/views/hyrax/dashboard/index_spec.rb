RSpec.describe "hyrax/dashboard/index.html.erb", type: :view do
  ...
  describe "heading" do
    ...
    context "when the user can't create works" do
      ...
      it "does not display the create work button" do
        expect(heading).not_to have_link("Create Work", href: new_hyrax_generic_work_path)
      end
    end
  ...
  describe "sidebar" do
    ...
    it "has links to view and edit the user's profile" do
      expect(sidebar).to have_link 'View Profile', href: hyrax.profile_path(user)
      expect(sidebar).to have_link 'Edit Profile', href: hyrax.edit_profile_path(user)
    end
