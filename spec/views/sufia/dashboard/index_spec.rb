RSpec.describe "sufia/dashboard/index.html.erb", type: :view do
  ...
  before do
    stub_template('sufia/dashboard/_create_work_action.html.erb' => "Create Work Stub")
  ...
  describe "heading" do
    ...
    context "when the user can't create works" do
      ...
      it "does not display the create work button" do
        expect(heading).not_to have_link("Create Work", href: new_sufia_generic_work_path)
      end
    end
