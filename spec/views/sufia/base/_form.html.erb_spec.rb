describe 'sufia/base/_form.html.erb', type: :view do
  ...
  before do
    ...
    allow(controller).to receive(:repository).and_return(Sufia::GenericWorksController.new.repository)
    allow(controller).to receive(:blacklight_config).and_return(Sufia::GenericWorksController.new.blacklight_config)
  end
