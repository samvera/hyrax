...
describe 'Routes for single use links', type: :routing do
  ...
  describe 'Single Use Link Viewer' do
    it 'routes to #show' do
      ...
      expect(get("/single_use_link/show/abc123")).to route_to("sufia/single_use_links_viewer#show", id: 'abc123')
    end

    it 'routes to #download' do
      expect(download_single_use_link_path('abc123')).to eq '/single_use_link/download/abc123'
      expect(get("/single_use_link/download/abc123")).to route_to("sufia/single_use_links_viewer#download", id: 'abc123')
    end
  end
  ...
  describe 'Single Use Link Generator' do
    it 'routes to #create_show' do
      ...
      expect(post("/single_use_link/generate_show/abc123")).to route_to("sufia/single_use_links#create_show", id: 'abc123')
    end
    ...
    it 'routes to #create_download' do
      ...
      expect(post("/single_use_link/generate_download/abc123")).to route_to("sufia/single_use_links#create_download", id: 'abc123')
    end
  end
end
