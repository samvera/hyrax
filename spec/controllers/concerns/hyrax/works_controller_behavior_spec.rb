...
RSpec.describe Hyrax::WorksControllerBehavior, :clean_repo, type: :controller do
  ...
  describe '#redirect_to_display_url' do
    ...
    context 'when the record has a display URL' do
      before { Hyrax::RedirectPath.create!(path: '/robs-cat-study', resource_id: work.id.to_s, display_url: true) }
    ...
    context 'when the redirects feature is inactive' do
      before do
        ...
        Hyrax::RedirectPath.create!(path: '/robs-cat-study', resource_id: work.id.to_s, display_url: true)
      end
