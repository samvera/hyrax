...
RSpec.describe Hyrax::Redirects::Middleware do
  ...
  context 'with the display alias itself (target_path = nil)' do
    let(:render_path) { '/robs-cat-study' }
    ...
    it 'rewrites PATH_INFO to the visited path and lets the downstream app handle it' do
